...
class CustomerAddressModel extends CustomerAddressEntity {
  const CustomerAddressModel({
    ...
    // 🎯 FIX 1: Uses the base class type hint to fix the super shortcut compilation rule
  ...
  factory CustomerAddressModel.fromJson(Map<String, dynamic> json) {
    try {
      return CustomerAddressModel(
        ...
        // 🎯 FIX 2: Explicit string null-safety protection against explicit backend null keys
        addressLine1:
